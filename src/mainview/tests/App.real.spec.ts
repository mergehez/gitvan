...
const realAppMethods = {
    ...
    getFileDiff: (params: { repoId: number; path: string; kind: 'staged' | 'unstaged' }) => app.getFileDiff(params),
    ...
    getCommitDetail: (params: { repoId: number; commitSha: string }) => app.getCommitDetail(params),
    getCommitFileDiff: (params: { repoId: number; commitSha: string; path: string; previousPath?: string | undefined }) => app.getCommitFileDiff(params),
